package by.bsu.courseproject.web.security;
...
public class JwtManager {
    ...
    @Value("${custom.secrets.access-key}")
    public void setAccessKey(String key) {
        accessKey = Keys.hmacShaKeyFor(Decoders.BASE64.decode(key));
    }

    @Value("${custom.secrets.refresh-key}")
    ...
    public String generateAccessToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60))  //todo
    ...
    public String generateRefreshToken(UserDetails userDetails) {
        return Jwts
                ...
                .setSubject(userDetails.getUsername())
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 24 * 7)) //todo
